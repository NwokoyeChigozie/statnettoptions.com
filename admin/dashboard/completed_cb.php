...
`paid_status`='completed' WHERE `id`= '$o_id'";  
  if($result = mysqli_query($link, $sql)){
           
      
       echo "<div class='alert alert-success'>Cash Back successfully Completed!!</div>";
      //header("location:enter.php");
       header("Refresh:1; url=payment_requests.php");
             }else{
    echo "<div class='alert alert-error'>Error occured, Try again later</div>"; 
       header("Refresh:2; url=payment_requests.php");
